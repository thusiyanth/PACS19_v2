...

{
	...
	public function predection()
	{

     
     $data['radius_mean']                     	    = $this->input->post('radius_mean');
     $data['texture_mean']                      	= $this->input->post('texture_mean');
     $data['concavity_mean']                        = $this->input->post('concavity_mean');
     $data['concave points_mean']                   = $this->input->post('concave points_mean');
     $data['area_se']                               = $this->input->post('area_se');
     $data['radius_worst']                          = $this->input->post('radius_worst');
     $data['texture_worst']                         = $this->input->post('texture_worst');
     $data['perimeter_worst']                       = $this->input->post('perimeter_worst');
     $data['area_worst']                            = $this->input->post('area_worst');
     $data['concavity_worst']                       = $this->input->post('concavity_worst');
     $data['concave points_worst']                  = $this->input->post('concave points_worst');

     echo '<pre>'.json_encode($this->input->post(),JSON_PRETTY_PRINT).'</pre>';
     //redirect(base_url() . 'index.php?doctor/PACS', 'refresh');
